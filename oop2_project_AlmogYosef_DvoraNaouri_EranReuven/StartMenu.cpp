...
StartMenu::StartMenu(Player& player)
	: m_player(player), m_menu(Resource::texture("main_menu"), Vector2f(1.f, 4.f), false, Resource::texture("mainMenu_arrow")) ,m_subScreen(nullptr)
{
	//resource\sounds
	//m_music.openFromFile("resource/sounds/Opening.mp3");
